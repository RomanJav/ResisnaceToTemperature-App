        ...
        btnResult.setOnClickListener {
            if (!textInputValue.text.isNullOrEmpty()) {
                if (switchTempRes.isChecked)
                    converterResult.text = temperatureResistancePresenter.getResistance(textInputValue.text.toString())
                else
                    converterResult.text = temperatureResistancePresenter.getTemperature(textInputValue.text.toString())
            }
        }
